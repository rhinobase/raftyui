...
export const ICONS: Record<string, { label: string; icon: IconType }> = {
  ...
  "arrow-left-circle": {
    ...
    icon: HiOutlineArrowLeftCircle,
  },
  "arrow-left-onRectangle": {
    label: "Arrow Left OnRectangle",
  ...
  "arrow-right-onRectangle": {
    label: "Arrow Right OnRectangle",
    icon: HiOutlineArrowRightOnRectangle,
  },
  "arrow-small-down": {
    label: "Arrow Small Down",
    icon: HiOutlineArrowSmallDown,
  },
  "arrow-small-left": {
