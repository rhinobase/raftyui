...
import { ToggleGroupContext, ToggleGroupProvider, useToggleGroupContext } from "./context";

// ToggleGroup Component
type ToggleGroupProps = ComponentProps<typeof ToggleGroupPrimitive["Root"]>;
export const ToggleGroup = forwardRef<HTMLDivElement, ToggleGroupContext & ToggleGroupProps>(
...
type ToggleItemProps = ComponentProps<typeof ToggleGroupPrimitive["Item"]>;
export const ToggleItem = forwardRef<HTMLButtonElement, ToggleGroupContext & ToggleItemProps>(
