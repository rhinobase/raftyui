      ...
      <>
        <input
          ...
          className={classNames(
            "dark:text-secondary-200 border-secondary-300 block w-full appearance-none rounded-md border bg-transparent px-3 py-2 shadow-sm autofill:bg-transparent dark:border-zinc-700",
