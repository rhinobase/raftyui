...
export const Box = forwardRef<HTMLButtonElement, Box>(
  ({ className, children, ...props }, forwardedRef) => {
    return (
      <RadioGroupPrimitives.Item
        className={classNames(
          "data-[state=checked]:ring-primary-500 dark:data-[state=checked]:ring-primary-300 hover:bg-secondary-100 data-[disabled]:bg-secondary-100 dark:border-secondary-700 dark:text-secondary-100 dark:hover:bg-secondary-800 dark:data-[disabled]:bg-secondary-800 w-full rounded-md border p-2 data-[disabled]:cursor-not-allowed data-[state=checked]:ring-2",
          className,
        )}
        {...props}
        ref={forwardedRef}
