...
type AlertDialog = ComponentProps<
  (typeof AlertDialogPrimitive)["AlertDialog"]
> &
  AlertDialogContext;
export const AlertDialog = React.forwardRef<HTMLDivElement, AlertDialog>(
...
type AlertDialogButton = ComponentProps<
  (typeof AlertDialogPrimitive)["AlertDialogTrigger"]
> &
  Button;
export const AlertDialogButton = React.forwardRef<
  HTMLButtonElement,
  AlertDialogButton
>(
  (
...
type AlertDialogContent = ComponentProps<
...
type AlertDialogTitle = ComponentProps<
...
type AlertDialogBody = ComponentProps<
