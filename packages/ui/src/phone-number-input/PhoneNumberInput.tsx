...
import { InputGroup, LeftAddon } from "../input-group";
        ...
        <LeftAddon className="p-0">
          ...
          >
            <ComboboxTrigger
              ...
              className="group py-1 ring-offset-0 hover:bg-transparent focus:ring-0 dark:ring-offset-0 dark:hover:bg-transparent [&>span]:text-xs [&>span]:font-semibold [&>span]:leading-5"
              variant="ghost"
            >
