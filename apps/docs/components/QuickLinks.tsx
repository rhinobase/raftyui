  ...
  return (
    <div className="border-secondary-200 dark:border-secondary-800 group relative rounded-xl border">
      ...
      <div className="relative overflow-hidden rounded-xl p-6">
        ...
        <h2 className="font-display text-secondary-900 mt-4 text-[1rem] leading-[2rem] dark:text-white">
          <Link href={href}>
            <span className="absolute -inset-px rounded-xl" />
            {title}
          </Link>
        </h2>
        <p className="text-secondary-700 dark:text-secondary-400 mt-1 text-[0.875rem] leading-[1.5rem]">
          {description}
        </p>
      </div>
    </div>
