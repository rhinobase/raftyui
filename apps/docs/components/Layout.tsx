...
const navigation = [
  ...
  },
  {
    ...
    links: [
      ...
      { title: "Stat", href: "/components/stat" },
      { title: "Switch", href: "/components/switch" },
      { title: "Tab", href: "/components/tab" },
      { title: "Table", href: "/components/table" },
      { title: "Tag", href: "/components/tag" },
      { title: "Tag Field", href: "/components/tag-field" },
