...
The showCloseButton prop exists in DialogContent sub-component and it is used to show/hide default close button in Dialog. Its default value is true.
...
<Dialog>
  <DialogTrigger
    isUnstyled
    className="hover:bg-secondary-100 dark:hover:bg-secondary-800 rounded-lg  p-2 px-4"
  >
    open
  </DialogTrigger>
  <DialogOverlay />
...
This component is built on top of [Radix Dialog](https://www.radix-ui.com/primitives/docs/components/D#root)

| Property   | Description                                               | Type                                                | Default |
| ---------- | --------------------------------------------------------- | --------------------------------------------------- | ------- |
| size       | Size of the dialog and its sub-components.                | `"sm"` or `"md"` or `"lg"` or `"xl"` or `undefined` | `"md"`  |
| isUnstyled | Removes style from whole component and its sub-components | `boolean` or `undefined`                            | `false` |

### DialogTrigger

This component is built on top of [Radix Dialog Trigger](https://www.radix-ui.com/primitives/docs/components/dialog#trigger) and using [Button](https://rafty.rhinobase.io/docs/components/button)
...
| Property        | Description                         | Type                     | Default |
| --------------- | ----------------------------------- | ------------------------ | ------- |
| showCloseButton | To show default dialog close button | `boolean` or `undefined` | `true`  |
| isUnstyled      | Remove style from this component    | `boolean` or `undefined` | `false` |
